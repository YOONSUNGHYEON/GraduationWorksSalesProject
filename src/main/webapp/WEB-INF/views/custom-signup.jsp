...
<div class="inner-space signup" tabindex="-1" role="dialog" style="width: 750px; text-align:center; margin-left: 565px;">
    <div class="dialog">
            ...
            <div class="body">
                <div class="custom-form">
                    <div class="form-wrapper">
                        <input type="text" class="form-control mb-3" id="register-email" name="email" placeholder="Email Address">
                        <input type="text" class="form-control mb-3" id="register-username" name="nickname" placeholder="nickname">
                        <input type="text" class="form-control mb-3" id="register-userphonenum" name="phonenum" placeholder="phone number 000-0000-00000">
                        <input type="password" class="form-control mb-3" id="register-password-input" name="password" placeholder="Password">
                        ...
                        <div class="form-inline-extras sixty-fourty">
                            ...
                            <div class="right-area">
                                <div class="right-area">
                                    <div class="right-area">
                                        <button type="submit" class="btn btn-primary rectangle">REGISTER</button>
                                    </div><!-- / right-area -->
