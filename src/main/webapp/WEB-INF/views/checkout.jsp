    ...
    <div class="container">
        <div class="row checkout-screen">
            <div class="col-md-9 checkout-form">
                <h4>CHECKOUT</h4>
                <p class="have-account space-bottom">Already have an account? <a href="#x" data-toggle="modal" data-target=".login-modal"><span>Login</span></a></p>
                <div class="row">
                ...
                <div class="checkout-form-footer">
                    ...
                    <a href="" class="btn btn-black rectangle"><span>CHECKOUT</span></a>
                </div><!-- / checkout-form-footer -->

            </div><!-- / checkout-form -->

            <div class="col-md-3 checkout-total">
                <h4>CART TOTAL: <span class="text-primary">$49.98</span></h4>
                <p class="text-sm">*The price includes shipping and taxes.</p>
                <div class="cart-total-footer">
                    <a href="shopping-cart.html" class="btn btn-black rectangle mt-2"><span>BACK TO CART</span></a>
                    <a href="index.html" class="btn btn-primary rectangle mt-2"><span>CONTINUE SHOPPING</span></a>
